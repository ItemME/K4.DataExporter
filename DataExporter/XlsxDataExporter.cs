...
namespace DataExporter
{
    public class XlsxDataExporter : DataExporter
    {
        ...
        public XlsxDataExporter(bool dataSetTemplate)
        {
        ...
        protected override void NewSheet(string name)
        {
            ...
            worksheetPart = workbookPart.AddNewPart<WorksheetPart>(sheetId);
        ...
        protected override SheetData GetSheetData()
        {
            return sheetData;
        }

        protected override WorksheetPart GetWorksheetPart()
        {
            return worksheetPart;
        }

        protected override WorkbookPart GetWorkbookPart()
        {
            return workbookPart;
        }
    }
